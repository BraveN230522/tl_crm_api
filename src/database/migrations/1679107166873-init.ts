...
export class init1679107166873 implements MigrationInterface {
    name = 'init1679107166873'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "chance_process" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "step" integer NOT NULL, "title" character varying NOT NULL, "content" character varying NOT NULL, "chanceId" integer, CONSTRAINT "PK_9eaf257a209b096117a6a08e37b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "chance" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "name" character varying NOT NULL, "current_process" integer, "userId" integer, CONSTRAINT "PK_0cfd3306686e2ab26f3fc6970de" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "username" character varying NOT NULL, "password" character varying NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "phone" character varying NOT NULL, "email" character varying, "forgot_password_otp" character varying, "is_forgot_password" boolean DEFAULT false, "role" character varying NOT NULL, "token" character varying, "branchId" integer, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_8e1f623798118e629b46a9e6299" UNIQUE ("phone"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "branch" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "name" character varying NOT NULL, "announcements" character varying NOT NULL, "customer_url" character varying NOT NULL, "is_active_tiers" boolean NOT NULL, CONSTRAINT "UQ_d6d14945d4352867ecc62bcf85c" UNIQUE ("name"), CONSTRAINT "PK_2e39f426e2faefdaa93c5961976" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tier" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "name" character varying NOT NULL, "desc" character varying NOT NULL, "status" integer NOT NULL, "level" integer NOT NULL, "gap" integer NOT NULL, "tier_rate" character varying NOT NULL, "dob_tier_rate" integer NOT NULL, "storeId" integer, CONSTRAINT "PK_14d67ceef0dbea040e39e97e7f6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "customer" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "phone" character varying NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "dob" integer NOT NULL, "gender" "public"."customer_gender_enum" NOT NULL DEFAULT '2', "address" character varying NOT NULL, "point" integer NOT NULL, "cashback" integer NOT NULL, "rate" integer NOT NULL, "tierId" integer, CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "name" character varying NOT NULL, "desc" character varying NOT NULL, "category" character varying NOT NULL, "cost" integer NOT NULL, "quantity" integer NOT NULL, "image" character varying NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "rule" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "title" character varying NOT NULL, "start_time" character varying NOT NULL, "endTime" character varying NOT NULL, "store_image" character varying NOT NULL, "privacy_policy" character varying NOT NULL, "rule_rate" integer NOT NULL, "dob_rule_rate" integer NOT NULL, "storeId" integer, CONSTRAINT "PK_a5577f464213af7ffbe866e3cb5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "store" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "email" character varying NOT NULL, "phone" character varying NOT NULL, "business_type" character varying NOT NULL, "store_image" character varying NOT NULL, "privacy_policy" character varying NOT NULL, "branchId" integer, "campaignId" integer, CONSTRAINT "PK_f3172007d4de5ae8e7692759d79" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "campaign" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "name" integer NOT NULL, "desc" character varying NOT NULL, CONSTRAINT "PK_0ce34d26e7f2eb316a3a592cdc4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order" ("id" SERIAL NOT NULL, "created_at" bigint NOT NULL DEFAULT '1679107167964', "updated_at" bigint NOT NULL DEFAULT '1679107167964', "name" character varying NOT NULL, "status" "public"."order_status_enum" NOT NULL DEFAULT '0', "total" character varying NOT NULL, "importerId" integer, "exporterId" integer, CONSTRAINT "REL_49938df2803ef1bb934d82c455" UNIQUE ("importerId"), CONSTRAINT "REL_516877a49093a6d9a21c4c1a25" UNIQUE ("exporterId"), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
